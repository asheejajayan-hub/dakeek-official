...
export default function TechSpecs({ specs, tools, details, theme }: TechSpecsProps) {
    const dynamicBorder = "border-[length:var(--border-width)] border-black/5"; // Simplified or use a variable
        ...
        <section className={`w-full px-[5vw] py-16 md:py-24 ${dynamicBg}`}>
            <div className="flex flex-col lg:flex-row gap-20">
                ...
                <div className="flex-1">
                    ...
                    {/* The Grid lines need to match the theme. slate-200 is default. Let's make it smarter. */}

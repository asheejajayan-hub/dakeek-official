...
export default function Footer() {
    ...
    const socialLinks = [
        { name: "Instagram", href: "#" },
        { name: "LinkedIn", href: "#" },
        { name: "Email", href: "mailto:info@dakeek.ae" },
        { name: "Phone", href: "tel:+97150000000" }
    ];
            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="/careers" className={`font-mono text-xs uppercase tracking-widest hover:translate-x-2 transition-transform duration-300 block w-fit ${theme.header}`}>
                            Careers
                        </Link>
                        <Link href="/legal" className={`font-mono text-xs uppercase tracking-widest hover:translate-x-2 transition-transform duration-300 block w-fit ${theme.header}`}>
                            Legal
                        </Link>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="/faq" className={`font-mono text-xs uppercase tracking-widest hover:translate-x-2 transition-transform duration-300 block w-fit ${theme.header}`}>
                            FAQ
                        </Link>
                    ...
                    <div className="flex flex-col gap-4">
                        {socialLinks.map((link) => (
                            <a
                                key={link.name}
                                href={link.href}
                                className={`font-mono text-xs uppercase tracking-widest hover:translate-x-2 transition-transform duration-300 block w-fit ${theme.header}`}
                            >
                                {link.name}
                            </a>
                        ))}
